...
<div class="container seller_detail" style="border: 1px solid #4179e8; border-radius: 20px; padding: 30px; height: 200px;">
    <div class="row" style="height: 100%;">
        <div class="col-lg-3 d-flex" style="height: 100%; justify-content: center; align-items: center;">
            <img style="width: 100%" src="<?= $data["seller"]->profile_picture ?>">
        </div>
        <div class="col-lg-6">
            <div class="d-flex flex-column">
                <div style="font-size: 30px; font-weight: 600;"><?= $data["seller"]->name ?></div>
                <div style="font-size: 15px; color: #545454;"><?= $data["seller"]->city_name ?> <span style="padding: 0 5px; color: #000000;">|</span> <?= $data["transaction"] ?> Produk Terjual</div>
            </div>
        </div>
        <div class="col-lg-3 d-flex" style="height: 100%; justify-content: center; align-items: center;">
...
<script>
    ...
    function filter() {
        ...
        $.ajax({
            data: {
                id_seller: "<?= $data["seller"]->id_seller ?>",
                id_category: category,
                min_price: minPrice,
                max_price: maxPrice,
                min_stock: minStock
            },
            url: "{{ url('seller/filter') }}",
            method: 'POST',
